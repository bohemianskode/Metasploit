...
echo -e "
       ...
       PRINTEDBY BOHEMIANSKODE
                  ${Green}[ ${Yellow}https://github.com/bohemianskode/Metasploit.git${clear} ${Green}]${clear}
"
echo -e "[${Green}+${clear}] Kali ini Anda tidak perlu membersihkan termux Anda..."
sleep 1
echo -e "[${Green}+${clear}] Saya akan mengatur semua..."
sleep 1
...
echo
echo -e "[${Yellow}+${clear}] Mohon Tunggu..."
sleep 3
echo "[+] Termux Sedang Melakukan Update..."
sleep 3
echo -e "[${Yellow}+${clear}] klik Y/y untuk Melanjutkan Penginstalan..."
sleep 3
clear
echo -e "
...
echo
echo -e "[${Yellow}+${clear}] Termux Sedang Melakukan update..."
echo -e "[${Yellow}+${clear}] Mohon Tunggu..."
sleep 3
...
sleep 3
echo 
echo -en "[${Yellow}+${clear}] ${White}Press ${Green}Klik ENTER untuk memperbaiki${clear}:"
read replyme
if [[ $replyme == "" ]]
then
...
echo -e "[${Yellow}+${clear}] 
Oke! Metasploit6 anda sudah aktif "terimaksih Rapid7"..."
else
echo -e "$replyme"
